    ...
    <div className="flex-1 p-4 lg:p-8 overflow-y-auto w-full">
      ...
      <div className="max-w-4xl">
        ...
        <div className="flex items-center gap-6 border-b border-gray-200 mb-8 overflow-x-auto">
          <button className="pb-4 border-b-2 border-indigo-600 text-indigo-600 font-medium whitespace-nowrap">
            Profile
          </button>
        </div>
        ...
        <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none bg-white text-gray-900"
                />
              </div>
            </div>
            <div>
          ...
          <div className="mt-6">
            ...
            <textarea
              ...
              className="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none resize-none bg-white text-gray-900"
          ...
          <div className="mt-8 flex items-center justify-end gap-4">
            ...
            <button
              onClick={handleSave}
              disabled={loading}
              className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-black px-6 py-2.5 rounded-lg font-semibold transition shadow-lg shadow-indigo-500/30 disabled:opacity-70"
            >
              {loading ? (
        ...
        <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-8">
          ...
          {billing?.plan === "PRO" ? (
            <button
              ...
              className="flex items-center gap-2 bg-gray-100 text-gray-800 px-6 py-2.5 rounded-lg font-semibold transition hover:bg-gray-200 disabled:opacity-70"
            >
